                ...
                <div class="card bg-light p-4">
                    <div class="row p-3">
                        <div class="col-lg-6 offset-3">
                            <input type="text" class="form-control" id="input-pokemon"
                    ...
                    <div class="row p-3">
                            ...
                            <div id="carouselId" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner text-center" role="listbox">
                                    <div class="carousel-item active">
                                        <img id="img-pokemon1" class="rounded-circle bg-danger" height="200px" width="200px"  src="{{$infoPokemon["imagenes"]->front_default}}" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img id="img-pokemon2" class="rounded-circle bg-danger" height="200px" width="200px" src="{{$infoPokemon["imagenes"]->other->dream_world->front_default}}" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img id="img-pokemon3" class="rounded-circle bg-danger" height="200px" width="200px" src="{{$infoPokemon["imagenes"]->back_default}}" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="text-center">
                                <h2><b>{{$infoPokemon["nombre"]}}</b></h2>
                            </div>
                            <div class="list-group">
                                <div class="list-group-item text-center">
                                    <b>HP: </b> {{$infoPokemon["stats"][0]->base_stat}}
                                </div>
                                <div class="list-group-item text-center">
                                    <b>Ataque: </b> {{$infoPokemon["stats"][1]->base_stat}}
                                </div>
                                <div class="list-group-item text-center">
                                    <b>Defensa: </b> {{$infoPokemon["stats"][2]->base_stat}}
                                </div>
                                <div class="list-group-item text-center">
                                    <b>Ataque especial: </b> {{$infoPokemon["stats"][3]->base_stat}}
                                </div>
                                <div class="list-group-item text-center">
                                    <b>Defensa especial: </b> {{$infoPokemon["stats"][4]->base_stat}}
                                </div>
                                <div class="list-group-item text-center">
                                    <b>Velocidad: </b> {{$infoPokemon["stats"][5]->base_stat}}
                                </div>
                            </div>
                        </div>
                    </div>
